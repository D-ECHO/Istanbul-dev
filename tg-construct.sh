case $1 in
	...
	2) geo='--min-lon=30.0 --max-lon=31.0 --min-lat=36.5 --max-lat=37.25';;		# Antalya (LTAI)
	3) geo='--min-lon=26.75 --max-lon=27.5 --min-lat=38.0 --max-lat=38.75';;	# Izmir (LTBJ, LTBK, LTFA, LTBL)
	...
	7) geo='--min-lon=32.25 --max-lon=33.25 --min-lat=39.75 --max-lat=40.25';;	# Ankara (LTAB, LTAC, LTAD, LTAE)
